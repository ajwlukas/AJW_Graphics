...
static constexpr unsigned MaxPath = 260;    /* max. length of full pathname */
static constexpr unsigned MaxDrive = 3;    /* max. length of drive component */
static constexpr unsigned MaxDir = 256;    /* max. length of path component */
static constexpr unsigned MaxFilename = 256;    /* max. length of file name component */
static constexpr unsigned MaxExtension = 256;    /* max. length of extension component */
