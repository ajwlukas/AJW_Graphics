//-------------------------------------------------------------------------------------
// TL_Math.h -- Simplified C++ Math wrapper for SimpleMath
//
...
#ifndef __TL_MATH_DEFINED__
#define __TL_MATH_DEFINED__
...
namespace std
{
	...
	template<> struct less<TL_Math::Rectangle>
	{
		bool operator()(const TL_Math::Rectangle& r1, const TL_Math::Rectangle& r2) const noexcept
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<TL_Math::Vector2>
	{
		bool operator()(const TL_Math::Vector2& V1, const TL_Math::Vector2& V2) const noexcept
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<TL_Math::Vector3>
	{
		bool operator()(const TL_Math::Vector3& V1, const TL_Math::Vector3& V2) const noexcept
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<TL_Math::Vector4>
	{
		bool operator()(const TL_Math::Vector4& V1, const TL_Math::Vector4& V2) const noexcept
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<TL_Math::Matrix>
	{
		bool operator()(const TL_Math::Matrix& M1, const TL_Math::Matrix& M2) const noexcept
		{
	...
	template<> struct less<TL_Math::Plane>
	{
		bool operator()(const TL_Math::Plane& P1, const TL_Math::Plane& P2) const noexcept
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<TL_Math::Quaternion>
	{
		bool operator()(const TL_Math::Quaternion& Q1, const TL_Math::Quaternion& Q2) const noexcept
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<TL_Math::Color>
	{
		bool operator()(const TL_Math::Color& C1, const TL_Math::Color& C2) const noexcept
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<TL_Math::Ray>
	{
		bool operator()(const TL_Math::Ray& R1, const TL_Math::Ray& R2) const noexcept
		{
	...
	template<> struct less<TL_Math::Viewport>
	{
		bool operator()(const TL_Math::Viewport& vp1, const TL_Math::Viewport& vp2) const noexcept
		{
